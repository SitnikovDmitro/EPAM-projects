  ...
  <body>
    ...
    <div class="row m-3">
      <div class="container col-md-6">
        <h2 class="text-center mb-3 mt-3">${st.getText('master_registration', lg)}</h2>

        <form action="${pageContext.request.contextPath}/controller?action=registerMaster" method="post">
          ...
          <div class="mb-3">
            <label for="information" class="form-label" maxlength="400">${st.getText('information', lg)}</label>
            <textarea class="form-control" aria-label="With textarea" id="information" name="information"></textarea>
          </div>
