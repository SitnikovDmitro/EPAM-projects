    ...
    <div class="text-center">
      <div class="btn-group mt-3" role="group">
        <c:if test="${lang == 'UK'}">
          ...
          <a type="button" href="${pageContext.request.contextPath}/controller?action=changeCashierLanguage&lang=RU" class="btn btn-secondary">РУС</a>
          <a type="button" href="${pageContext.request.contextPath}/controller?action=changeCashierLanguage&lang=EN" class="btn btn-secondary">ENG</a>
        </c:if>

        <c:if test="${lang == 'RU'}">
          <a type="button" href="${pageContext.request.contextPath}/controller?action=changeCashierLanguage&lang=UK" class="btn btn-secondary">УКР</a>
