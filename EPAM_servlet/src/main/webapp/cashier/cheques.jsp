  ...
  <body>
    ...
    <div class="row">
      <div class="container col-md-6">
        ...
        <div class="card mb-3">
          <div class="card-body">
            <form action="${pageContext.request.contextPath}/controller?action=setCashierCheques" method="post">
              <div class="row">
                <div class="col-sm-6">
                  <div class="mb-3">
          ...
          <div class="container col-sm-6">
            ...
            <c:choose>
              <c:when test="${not empty cheques}">
                <c:forEach var="cheque" items="${cheques}" varStatus="loop">

                  <div class="card mb-3">
                    <ul class="list-group list-group-flush">
                      <c:forEach var="chequeLine" items="${chequeLines[loop.index]}">
        ...
        <div class="text-center">
          <div class="btn-group mt-3" role="group">
            <c:forEach var="page" items="${pages}">
              <a href="${pageContext.request.contextPath}/controller?action=showCashierCheques&page=${page}" type="button" class="btn btn-secondary">${page}</a>
            </c:forEach>
          </div>
        </div>
    ...
    <script>
      function completeModal(action, success) {
        ...
        fetch("${pageContext.request.contextPath}/controller?action=createCashierReport", { method: "POST", body: data }).then(
