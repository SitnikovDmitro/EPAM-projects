  ...
  <body>
    ...
    <div class="modal fade" id="productAmountModal" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <form action="${pageContext.request.contextPath}/cashier/addProductToCheque" method="post" id="seniorCashierVerificationForm">
    ...
    <div class="row m-3">
      <div class="container col-md-6">
        ...
        <div class="card mb-3">
          <div class="card-body">
            <form action="${pageContext.request.contextPath}/cashier/setProducts" method="post">
        ...
        <div class="text-center">
          <div class="btn-group mt-3" role="group">
            <c:forEach var="page" items="${pages}">
              <a href="${pageContext.request.contextPath}/cashier/showProducts?page=${page}" type="button" class="btn btn-secondary">${page}</a>
            </c:forEach>
          </div>
        </div>
