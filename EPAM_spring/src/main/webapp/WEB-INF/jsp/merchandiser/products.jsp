  ...
  <body>
    ...
    <div class="modal fade" id="productAmountModal" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <form action="${pageContext.request.contextPath}/merchandiser/deliverProduct" method="post" id="seniorCashierVerificationForm">
    ...
    <div class="row m-3">
      <div class="container col-md-6">
        ...
        <div class="card mb-3">
          <div class="card-body">
            <form action="${pageContext.request.contextPath}/merchandiser/setProducts" method="post">
          ...
          <c:forEach var="product" items="${pageProducts}">
            <div class="col">
              <div class="card h-100">
                <img class="card-img-top" src="../../resources/files/images/${product.code}.jpg" onerror="this.onerror=null; this.src='files/images/default.jpg';" alt="Product image" height="200">
                <div class="card-body">
                ...
                <div class="card-body">
                  <form action="${pageContext.request.contextPath}/merchandiser/deleteProduct" method="post">
        ...
        <div class="text-center">
          <div class="btn-group mt-3" role="group">
            <c:forEach var="page" items="${pages}">
              <a href="${pageContext.request.contextPath}/merchandiser/showProducts?page=${page}" type="button" class="btn btn-secondary">${page}</a>
            </c:forEach>
          </div>
        </div>
